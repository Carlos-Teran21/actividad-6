...
class Login(tk.Tk):
    ...
    def __init__(self):
        ...
        self.logo = utl.leer_imagen(r"C:/Users/carlos/Downloads/LoginAppPart2/LoginAppPart2/imagenes/logo.png", (300, 100))
        self.user = utl.leer_imagen(r"C:/Users/carlos/Downloads/LoginAppPart2/LoginAppPart2/imagenes/login.png", (64, 64))
    ...
    def validar(self):
        with open(r"C:/Users/carlos/Downloads/LoginAppPart2/LoginAppPart2/db_users.json", "r", encoding='utf-8') as file:
